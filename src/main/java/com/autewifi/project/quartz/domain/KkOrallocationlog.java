...
/**
 * Created by AutoGenerator on 2021-08-06 09:40:55
 */
@Data
@ApiModel(description = "开卡订单分配记录")
@TableName("kk_orallocationlog")
public class KkOrallocationlog implements Serializable {
