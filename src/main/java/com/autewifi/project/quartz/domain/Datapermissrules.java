...
@TableName("kd_datapermissrules")
public class Datapermissrules implements Serializable {
    ...
    @ApiModelProperty(value = "归属地集合 河南省-新乡市,河南省-开封")
    @TableField("dpru_locations")
