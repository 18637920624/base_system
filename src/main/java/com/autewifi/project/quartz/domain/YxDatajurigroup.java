 ...
 */
@Data
@ApiModel(description = "营销活动数据权限组")
@TableName("yx_datajurigroup")
public class YxDatajurigroup implements Serializable {
    ...
    @ApiModelProperty(value = "超出时间回收订单 单位：小时，=0时不回收订单")
